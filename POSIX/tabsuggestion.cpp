...
// handle that tabcall count 
// if string change then make that count 0 again
// do command search as well
// if only one word then search only for command
// if anything has not type then still show suggestiopns
