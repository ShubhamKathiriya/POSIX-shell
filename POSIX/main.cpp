//echo with multiple quotes on after anoter not working properly handle it
//If we directly run our a.out file form any other folder than ??

//Do for single quote in echo
//echo "                    dnflk"  -> not working

//  Handle command not found error -> write now it is giving bin/sh error

//In pipe wait for child remove sleep
